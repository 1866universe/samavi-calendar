...
Drawing upon a data repository containing **232,887 precise astronomical points in time**, this system enables the calculation, tracking, and display of calendar data over a range equivalent to **693 astronomical years**, spanning from `1550-04-17` to `2210-04-16`.
...
### 2. Hijri Shamsi (Jalali) Calendar

The Hijri Shamsi calendar is a solar calendar with 12 months, whose beginning is aligned with the vernal equinox (Nowruz).
...
| --- | --- |
| **Samavi Epoch** | `0001-01-01 09:43:54 (Tuesday) UTC` |
| **Gregorian Equivalent** | `1550-04-18 09:43:54 UTC` |
| **Hijri Shamsi Equivalent** | `929-01-29 09:43:54 UTC` |
| **Hijri Qamari Equivalent** | `957-30-20 09:43:54 UTC` |
